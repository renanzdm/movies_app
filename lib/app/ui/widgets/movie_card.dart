...
class MovieCard extends StatelessWidget {
  ...
  final VoidCallback favoriteCalback;
  MovieCard({Key? key, required this.model, required this.favoriteCalback})
      : super(key: key);
                  ...
                  PhysicalModel(
                    ...
                    child: ClipRRect(
                      ...
                      child: FadeInImage.memoryNetwork(
                        ...
                        image:
                            'https://image.tmdb.org/t/p/w200${model.posterPath}',
                        width: 148,
                        height: _heightImage,
                        fit: BoxFit.cover,
                      ),
            ...
            Positioned(
              ...
              child: Material(
                ...
                child: SizedBox(
                  height: 30,
                  child: IconButton(
                    onPressed: favoriteCalback,
                    iconSize: 13,
                    icon: Icon(
                      model.favorite
                          ? MoviesAppIcons.heart
                          : MoviesAppIcons.heartEmpty,
                      color: model.favorite ? context.themeRed : Colors.grey,
                    ),
                  ),
                ),
              ),
